...
// Current OC monogram: open circle (O) plus open C stroke.
const CURRENT_GLYPH_MARKERS = ['cx="27" cy="41"', 'M63.2 51.3'];
// Retired Open Design ink-tile path and the older 444x444 dark cursor mark.
const RETIRED_GLYPH_MARKERS = ['M41 0.726562', '#202020', 'M212.059', 'width="444"'];
