...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Inferno — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrError.authMessage': 'Your Inferno account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Inferno allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with Inferno',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the Inferno agent — sign in and this task can start right away.',
  ...
  'chat.runError.title.signInRequired.amr': 'OpenComputer Design is not signed in',
  ...
  'chat.runError.title.runtimeConfig': "OpenComputer Design error",
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update OpenComputer Design to the latest version, which ships a compatible runtime.",
  ...
  'chat.runError.cliSessionRefusedMessage':
    "{agent} refused to start a session. The installed version is usually incompatible with OpenComputer Design — switch to a different version and retry.",
  ...
  'chat.runError.agentReplyIncompleteMessage': "The agent's reply came back without the marker OpenComputer Design needs to record this step, so the task couldn't move on. Nothing you sent was lost — this one is intermittent, and retrying usually goes through.",
  ...
  'app.brandSubtitle': 'by Open Computer',
  'app.welcomeLoading': 'Loading workspace…',
  'settings.welcomeKicker': '',
  'settings.welcomeTitle': 'Welcome to OpenComputer Design',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. OpenComputer Design will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. OpenComputer Design reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the OpenComputer Design hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingCloudTitle': 'Sign in to OpenComputer Design',
  'settings.onboardingCloudBody': 'Sign in to start designing with cloud AI right away — no complex setup required.',
  'settings.onboardingCloudSignIn': 'Sign in to OpenComputer Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Inferno to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the OpenComputer Design daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to OpenComputer Design.',
  ...
  'settings.amrAccountStatus': 'Inferno account status',
  ...
  'settings.mcpServerHint': 'Expose OpenComputer Design as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the OpenComputer Design team',
  'settings.privacyConsentKicker': 'Help us improve OpenComputer Design',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how OpenComputer Design performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time OpenComputer Design starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but OpenComputer Design could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect OpenComputer Design to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure OpenComputer Design is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in OpenComputer Design as context.',
  'settings.mcpRunningNote': 'Keep OpenComputer Design running. Restart your coding agent after setup.',
  ...
  'entry.discordLabel': 'Visit website',
  'entry.discordAria': 'Visit tryopencomputer.com',
  'entry.discordAriaWithOnline': 'Visit tryopencomputer.com',
  ...
  'entry.followLinkedinLabel': 'Follow OpenComputer Design on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow OpenComputer Design on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use Inferno and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss Inferno note",
  ...
  'homeHero.subtitlePrefix': 'Local-first design studio powered by Inferno.',
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable OpenComputer Design plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit Inferno',
  ...
  'handoff.promptIntro': 'Continue from this local OpenComputer Design project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. OpenComputer Design Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use OpenComputer Design workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with OpenComputer Design and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to OpenComputer Design',
  'pluginCard.contributeTitle': 'Contribute plugin to OpenComputer Design with a pull request',
  'integrations.kicker': 'Integration',
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use OpenComputer Design from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure OpenComputer Design is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use OpenComputer Design everywhere',
  'useEverywhere.modalTitle': 'Use OpenComputer Design everywhere',
  'useEverywhere.modalSubtitle': 'Drop OpenComputer Design into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'OpenComputer Design works wherever your agent works',
  'useEverywhere.section.overview.intro': 'OpenComputer Design is more than a window — it is a local privileged daemon (`ocd`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any MCP-capable agent can inspect projects and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `ocd <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires OpenComputer Design as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without OpenComputer Design at all.',
  ...
  'useEverywhere.section.overview.footer': 'The daemon writes to `~/.opencomputer-design` by default. Set `OCD_DATA_DIR` to override the data directory.',
  'useEverywhere.section.cli.tab': 'CLI · ocd',
  'useEverywhere.section.cli.heading': 'Drive OpenComputer Design from any shell',
  'useEverywhere.section.cli.intro': 'The `ocd` bin ships with the daemon. Most subcommands are thin clients that POST to the local daemon, so they work the same whether you launched it via `pnpm tools-dev` or as a packaged app.',
  'useEverywhere.section.cli.bullet1': '`ocd` (no args) — boots the daemon and opens the web UI.',
  'useEverywhere.section.cli.bullet2': '`ocd media generate ...` — produce image / video / audio bytes through the unified media protocol.',
  'useEverywhere.section.cli.bullet3': '`ocd run ...` — start a project run from a prompt + skill.',
  'useEverywhere.section.cli.bullet4': '`ocd plugin install <source>` / `ocd plugin apply <id>` — install and apply community plugins.',
  'useEverywhere.section.cli.bullet5': '`ocd skills list` / `ocd design-systems list` — inspect what is available locally.',
  'useEverywhere.section.cli.bullet6': '`ocd status` / `ocd doctor` — verify daemon health.',
  ...
  'useEverywhere.section.mcp.heading': 'Expose OpenComputer Design as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'OpenComputer Design ships with a Model Context Protocol server (`ocd mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover OpenComputer Design tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  'useEverywhere.section.mcp.bullet1': 'Stdio transport — no extra port, the client spawns `ocd mcp` directly.',
  ...
  'useEverywhere.section.mcp.bullet4': 'Pins `OCD_DATA_DIR` so the spawned MCP process writes to the same place the daemon already uses (avoids EPERM in packaged macOS app bundles).',
  ...
  'useEverywhere.section.mcp.footer': 'In the OpenComputer Design app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without OpenComputer Design running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). OpenComputer Design extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside OpenComputer Design and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.bullet4': 'Headless: an agent with `ocd` on its PATH can call `ocd skills list` then run any skill; the daemon is optional for read-only flows.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + OpenComputer Design extras)',
  ...
  'entry.githubStarAria': 'Star OpenComputer Design on GitHub',
  ...
  'newproj.locationDefault': 'OpenComputer Design projects',
  ...
  'socialShare.openDesignSection': 'Share OpenComputer Design',
  'socialShare.openDesignTitle': 'OpenComputer Design on GitHub',
  'socialShare.openDesignText': 'OpenComputer Design is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with OpenComputer Design: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with OpenComputer Design: {title}\n{url}\nOpenComputer Design repo: {repo}',
  ...
  'brandEnrichment.body': "OpenComputer Design will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask OpenComputer Design to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want OpenComputer Design to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure OpenComputer Design is running and try again.',
  'preview.retry': 'Retry',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'A share link needs a signed-in workspace. Sign in to Inferno, or use a deploy option to share this file.',
  ...
  'assistant.shareToOpenDesign': 'Share to OpenComputer Design',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with OpenComputer Design — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with OpenComputer Design — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple OpenComputer Design project folders. New projects are saved as one folder inside the selected base.',
  ...
  'settings.customInstructionsHint': 'Fixed instructions OpenComputer Design should follow in every chat. Save facts, preferences, and project context as memories.',
  ...
  'updater.availableBody': 'OpenComputer Design {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'OpenComputer Design is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'OpenComputer Design could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. OpenComputer Design is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit OpenComputer Design',
  'updater.quitFailedBody': 'The installer is open, but OpenComputer Design could not quit. Quit OpenComputer Design before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. OpenComputer Design will close and open the installer.',
  'updater.readyVersion': 'OpenComputer Design {version} is ready. OpenComputer Design will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. OpenComputer Design will close and open the installer.',
  'updater.reinstallReadyVersion': 'OpenComputer Design {version} requires a full reinstall. OpenComputer Design will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'OpenComputer Design {version} is here',
  ...
  'dsManager.createBody': 'Teach OpenComputer Design your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions OpenComputer Design follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach OpenComputer Design your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'OpenComputer Design turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 13–27, paid users can use DeepSeek V4 Pro and V4 Flash for free in OpenComputer Design. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 13–27',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'two weeks free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside OpenComputer Design — not via MCP, CLI, API, or other surfaces. Final interpretation rests with OpenComputer Design. Some models may need to queue at peak hours.',
  ...
  'experienceSurvey.tag': "We'd love your feedback — help improve OpenComputer Design",
  'experienceSurvey.close': "Close",
  'experienceSurvey.recommendation': "How likely are you to recommend OpenComputer Design to a colleague or friend?",
  ...
  'chat.designSystemStatus.description': 'OpenComputer Design is using the setup sources to generate this project.',
  ...
  'labs.harnessHint': "Your next generation will use OpenComputer Design's latest strategy, with noticeably more polished results (beta)",
  'labs.harnessTooltip': "Switches to the agent harness OpenComputer Design built for design work. Output is noticeably better in layout, structure, and completeness.",
