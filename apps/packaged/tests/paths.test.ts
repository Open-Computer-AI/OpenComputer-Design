...
function fakeConfig(): PackagedConfig {
  return {
    ...
    namespaceBaseRoot: join("C:", "Users", "Fred", "AppData", "Roaming", "OpenComputer Design", "namespaces"),
    nodeCommand: null,
    posthogHost: null,
    posthogKey: null,
    resourceRoot: join("C:", "Program Files", "OpenComputer Design", "resources", "open-design"),
